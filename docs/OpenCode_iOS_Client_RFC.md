...
- **模型与 Agent 选择器**：原 chip 横向滚动改为下拉列表（Menu + Picker）。模型列表固定（Opus 4.6 / Sonnet 4.6 / GPT-5.4 / GPT-5.3 Codex / GPT-5.2 / Gemini 3.1 Pro / Gemini 3 Flash）；Agent 列表从 `GET /agent` 动态获取（过滤 hidden）
